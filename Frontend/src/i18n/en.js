export default {
  ...
  wallet: 'Wallet',
  profile: 'Profile',
  profileOrganizer: "Profilo organizer",
  friends: "Friens",
  ...
  eventsActive: 'Event active',
  eventsUnActive: 'Event unactive',
  ...
  searchPlaceholder2: 'Find friends',
  new: 'New',
  empty: 'Empty',
  ...
  emailAlreadyConfirmed: 'Have you are already confirmed your email?',
  resendEmailText: 'Didn\'\t receive the email?',
  addToCalendar: 'Add to calendar',
  priceMan: 'Price man',
  priceWoman: 'Price woman',
  seatMan: 'Seats man',
  seatWoman: 'Seats woman',
